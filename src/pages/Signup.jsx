  ...
  return (
    ...
    <section className="bg-tahiti h-screen flex justify-center items-center">
      <div className="max-w-md w-full p-8 rounded-lg shadow-md">
        ...
        <button onClick={handleFacebookSignIn} className="bg-blue-light hover:bg-blue-700 text-white font-bold py-4 px-4 rounded mb-4 w-full flex justify-between items-center">
